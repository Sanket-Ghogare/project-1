...
export default function ContactContent() {
  return (
    <main>
      {/* Hero */}
      <section className="bg-gradient-to-br from-blue-950 via-blue-900 to-blue-800 py-24 pt-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <h1 className="text-5xl sm:text-6xl font-extrabold text-white mt-2 mb-4">
              Contact Us
            </h1>
          ...
          <div className="grid lg:grid-cols-3 gap-10">
            ...
            <div className="space-y-5">
              ...
              <motion.a
                ...
                className="flex items-center gap-4 bg-green-500 hover:bg-green-600 text-white rounded-2xl p-6 transition-colors shadow-md group"
              >
                <span className="text-3xl group-hover:scale-110 transition-transform">💬</span>
                <div>
                  <div className="font-extrabold text-lg">Chat on WhatsApp</div>
                  <div className="text-green-100 text-sm">Fastest response guaranteed</div>
                </div>
              </motion.a>
            </div>

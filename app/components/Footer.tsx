  ...
  return (
    <footer className="bg-gray-950 text-gray-400">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="sm:col-span-2 lg:col-span-2">
            ...
            <div className="space-y-2.5 text-sm text-gray-300">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="tel:+919834220116" className="hover:text-purple-400 transition-colors">
                  +91 98342 20116
                </a>
              </div>
              <div className="flex items-center gap-3">
                <span className="flex-shrink-0">✉️</span>
                <a href="mailto:asked@gocpl.co.in" className="hover:text-purple-400 transition-colors break-all">
                  asked@gocpl.co.in
                </a>
              </div>
              <div className="flex items-center gap-3">
        ...
        {/* Bottom bar */}
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-gray-400">
